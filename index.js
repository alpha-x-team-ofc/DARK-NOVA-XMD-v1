...
const sessdata = config.SESSION_ID.replace("DARK ALPHA ~", '');
...
console.log("CONNECTING DARK ALPHA XMD  🧬...");
...
console.log('DARK ALPHA XMD CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
> *➺ DARK ALPHA ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ alpha x team ✅*

> *❁ᴊᴏɪɴ ᴏᴜʀ ᴡʜᴀᴛsᴀᴘᴘ ᴄʜᴀɴɴᴇʟ ғᴏʀ ᴜᴘᴅᴀᴛᴇs 

*https://whatsapp.com/channel/0029Vb9yA9K9sBI799oc7U2T*

*DARK ALPHA XMD ACTIVE NOW ENJOY♥️🪄*\n\n*PREFIX: ${prefix}*
...
app.get("/", (req, res) => {
res.send("HEY, DARK ALPHA XMD STARTED ✅");
});
